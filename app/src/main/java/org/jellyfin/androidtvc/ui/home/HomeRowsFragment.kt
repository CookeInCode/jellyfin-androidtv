...
import org.jellyfin.androidtvc.ui.browsing.CompositeClickedListener
import org.jellyfin.androidtvc.ui.browsing.CompositeSelectedListener
...
class HomeRowsFragment : RowsSupportFragment(), AudioEventListener, View.OnKeyListener {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		lifecycleScope.launch(Dispatchers.IO) {
			...
			if (homesections.contains(HomeSectionType.LIVE_TV) && currentUser.policy?.enableLiveTvAccess == false) {
